...
public class Waiters {
  ...
  public static void appearElement(WebDriver driver, final WebElement element) {
    Wait<WebDriver> wait =
        new WebDriverWait(driver, Duration.ofSeconds(30)).ignoring(NoSuchElementException.class);
    wait.until(
  ...
  public static void appearElement(WebDriver driver, By by) {
    Wait<WebDriver> wait =
        new WebDriverWait(driver, Duration.ofSeconds(25)).ignoring(NoSuchElementException.class);
