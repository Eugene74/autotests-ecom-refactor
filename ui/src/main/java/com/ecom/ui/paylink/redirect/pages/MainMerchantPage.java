...
public class MainMerchantPage extends BasePage {
  ...
  @FindBy(
      css =
          "body > table:nth-child(3) > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(7) > td > a")
  private WebElement invoiceMerchantMenu;

  @CacheLookup
  @FindBy(
      css =
          "body > table:nth-child(3) > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(5) > td > a")
  ...
  @FindBy(
      css =
          "body > table:nth-child(3) > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(5) > td")
  private WebElement invoiceMerchantMenuRBAL;

  @CacheLookup
  @FindBy(
      css =
          "body > table:nth-child(3) > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(6) > td > a")
  ...
  public void getTransactionsMenuRBA() {
    tranMerchantMenuRBA.click();
  }
