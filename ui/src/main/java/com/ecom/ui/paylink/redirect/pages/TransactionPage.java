...
public class TransactionPage extends BasePage {
  ...
  @FindBy(
      css =
          "body > table:nth-child(3) > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(4) > td > a")
  ...
  @CacheLookup
  @FindBy(
      xpath = "/html/body/table[2]/tbody/tr/td/div/fieldset[2]/form/table/tbody/tr[2]/td/input[1]")
  ...
  @CacheLookup
  @FindBy(
      xpath = "/html/body/table[2]/tbody/tr/td/div/fieldset[3]/form/table/tbody/tr[2]/td/input[1]")
  ...
  @CacheLookup
  @FindBy(
      xpath = "/html/body/table[2]/tbody/tr/td/div/table/tbody/tr[1]/td[1]/table/tbody/tr[9]/td")
  ...
  @FindBy(
      css =
          "#content > fieldset:nth-child(4) > table > tbody > tr:nth-child(1) > td:nth-child(1) > table > tbody > tr:nth-child(10) > td")
  private WebElement getTotalAmountRBBG;

  @CacheLookup
  @FindBy(
      css =
          "body > div > div > div > div > div:nth-child(2) > div > ul > li:nth-child(1) > span.value")
  ...
  @CacheLookup
  @FindBy(
      css = "#content > fieldset:nth-child(2) > table > tbody > tr:nth-child(9) > td:nth-child(2)")
  ...
  public void selectTran(int tran) {
    Waiters.sleep(1500);
    Waiters.clickableElement(
        getDriver(), getDriver().findElement(By.linkText(String.valueOf(tran))));
