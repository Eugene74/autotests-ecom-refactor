...
public class MainPage extends BasePage {
  ...
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/div[2]/div/div/div[2]/div/form/div[1]/div[1]/div/div/div/ul")
  ...
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/div[2]/div/div/div[2]/div/form/div[2]/div[1]/div/div/div/label/input")
  protected WebElement merchantID;

  @CacheLookup
  @FindBy(
      xpath = "/html/body/div[1]/div/div/main/div/form/div[2]/div[2]/div/div[1]/div/div[3]/input")
  ...
  @CacheLookup
  // @FindBy(xpath =
  // "/html/body/div[1]/div/div/div[2]/div/div/div[2]/div/form/div[1]/div[1]/div/div[1]/div/div/div/label/input")
  @FindBy(
      xpath = "/html/body/div[1]/div/div/main/div/form/div[1]/div[1]/div/div[1]/div/div[3]/input")
  protected WebElement tranID_input;

  @CacheLookup
  @FindBy(
      xpath = "/html/body/div[1]/div/div/main/div/form/div[1]/div[3]/div/div[1]/div/div[3]/input")
  protected WebElement merchantID_input;

  @CacheLookup
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/div[2]/div/div/div[2]/div/form/div[1]/div[1]/div/div[2]/div/div/div/div/ul")
  ...
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/div[2]/div/div/div[2]/div/form/div[1]/div[2]/div/div[2]/div/div/div/div/div/label/input")
  ...
  @FindBy(
      xpath =
          "//*[@id=\"exachangeForm\"]/div[1]/div/div[2]/div/div/form/div[1]/div[1]/div/div/div/div/label/input")
  protected WebElement currencyFrom_input;

  @CacheLookup
  @FindBy(
      xpath =
          "//*[@id=\"exachangeForm\"]/div[1]/div/div[2]/div/div/form/div[1]/div[2]/div/div/div/div/label/input")
  protected WebElement currencyTo_input;

  @CacheLookup
  @FindBy(
      xpath =
          "/html/body/div[4]/div[1]/div/div[2]/div/div/form/div[1]/div[3]/div/div/div/label/input")
  protected WebElement rate_input;

  @CacheLookup
  @FindBy(
      xpath =
          "//*[@id=\"exachangeForm\"]/div[1]/div/div[2]/div/div/form/div[1]/div[4]/div/div/div/div/label/input")
  ...
  @FindBy(
      xpath =
          "//*[@id=\"exachangeForm\"]/div[1]/div/div[2]/div/div/form/div[1]/div[1]/div/div/div/div/ul")
  protected WebElement currencyFrom_list;

  @CacheLookup
  @FindBy(
      xpath =
          "//*[@id=\"exachangeForm\"]/div[1]/div/div[2]/div/div/form/div[1]/div[2]/div/div/div/div/ul")
  protected WebElement currencyTo_list;

  @CacheLookup
  @FindBy(
      xpath =
          "//*[@id=\"exachangeForm\"]/div[1]/div/div[2]/div/div/form/div[1]/div[4]/div/div/div/div/ul")
  ...
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/div[2]/div/div/div[2]/div/form/div[1]/div[2]/div/div[1]/div/div/div/div/label/input")
  protected WebElement statusCB_input;

  @CacheLookup
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/div[2]/div/div/div[2]/div/form/div[1]/div[2]/div/div[1]/div/div/div/div/ul")
  ...
  // @FindBy(xpath =
  // "//*[@id=\"app\"]/div/div/main/div/div/div[2]/div[2]/div/div/div[1]/div/div/div[2]/div/button[1]/span[3]")
  //  protected WebElement receipt_btn;

  @CacheLookup
  @FindBy(
      xpath =
          "//button[contains(@class, 'v-btn') and contains(@class, 'bg-primary') and .//span[text()='Receipt']]")
  protected WebElement receipt_btn;

  @CacheLookup
  // @FindBy(css =
  // ".mdi-menu.mdi.v-icon.notranslate.v-theme--myCustomLightTheme.v-icon--size-default")
  ...
  public class TimePickerPage {
    ...
    public void setTimeTwoMinutesAhead() {
      try {
        ...
        List<WebElement> timeInputs =
            timePickerOverlay.findElements(By.cssSelector(".dp__time_input"));
        ...
        for (int i = 0; i < timeInputs.size(); i++) {
          ...
          try {
            ...
            WebElement incrementMinutesButton =
                wait.until(
                    ExpectedConditions.visibilityOfElementLocated(
                        By.cssSelector("button[data-test-id='minutes-time-inc-btn-" + i + "']")));

            // Знаходить відображення хвилин
            WebElement minutesDisplay =
                timeInput.findElement(
                    By.cssSelector("button[data-test-id='minutes-toggle-overlay-btn-" + i + "']"));

            // Змінює значення хвилин на 2 вперед
            incrementTime(incrementMinutesButton, minutesDisplay, 2, 60);
          } catch (Exception e) {
            e.printStackTrace(); // Виводить помилку для конкретного елемента, якщо щось пішло не
            // так
          }
        }
      } catch (Exception e) {
    ...
    private void incrementTime(
        WebElement incrementButton, WebElement timeDisplay, int increment, int max)
  ...
  public boolean findRecordInResultTable(
      String merchantName, String merchantId, String terminalId) {
    ...
    if (!results.isEmpty() && resultTable_MerchTab.findElements(By.tagName("tr")).size() == 1) {
      for (WebElement result : results) {
        if (result.getText().equals(merchantName)
            || result.getText().equals(merchantId)
            || result.getText().equals(terminalId)) {
          count++;
        }
      }
    }
  ...
  public boolean doSearchByMerchant(String merchant) {
    try {
      ...
      WebElement merchantOption =
          wait.until(
              ExpectedConditions.visibilityOfElementLocated(
                  By.xpath("//div[@class='v-list-item-title' and text()='" + merchant + "']")));
    ...
    try {
      ...
      wait.until(
          ExpectedConditions.invisibilityOfElementWithText(
              By.cssSelector("tbody.v-data-table__tbody tr td"), "Loading items..."));
      // System.out.println("Таблиця завантажена.");

      // Вибір мерчанта зі списку
      List<WebElement> rows =
          resultTable_MerchTab.findElements(By.cssSelector("tbody.v-data-table__tbody tr"));
      ...
      for (WebElement row : rows) {
        ...
        if (cells.size() > 2 && cells.get(2).getText().equals(merchant)) {
          WebElement icon =
              cells
                  .get(cells.size() - 1)
                  .findElement(By.cssSelector("i.mdi-card-account-details-outline"));
          icon.click();
          merchantFound = true;
          break;
        }
  ...
  public boolean doSearchByMerchantID() {
    try {
      String merchant = MERCHANT_ID_AVAL;
  ...
  public boolean doSearchByMultFields() {
    try {
      ...
      String merchantId = MERCHANT_ID_AVAL;
      String terminalId = TERMINAL_ID_AVAL;
  ...
  public boolean findTransactionByMerchantId(String merchant, String trackingId) {
    try {
      ...
      WebElement merchantInput =
          merchantName.findElement(
              By.xpath(
                  "/html/body/div[1]/div/div/main/div/form/div[1]/div[2]/div/div[1]/div/div[3]/div/input"));
      Waiters.appearElement(getDriver(), merchantInput);
      merchantInput.click();
  ...
  public boolean findTransactionByMultFields(
      String merchant, String cardNumber, String trackingId) {
    clickElement(icon_menu);
    clickElement(moneyTransferTab);
    clickElement(domesticMTTab);
  ...
  public boolean findInterTransactionByMultFields(
      String merchant, String cardNumber, String trackingId) {
    Waiters.appearElement(getDriver(), moneyTransferTab);
    moneyTransferTab.click();
    Waiters.appearElement(getDriver(), interMTTab);
      ...
      WebElement openIcon =
          wait.until(
              ExpectedConditions.elementToBeClickable(
                  ...
                  By.cssSelector(
                      "i.mdi-folder-open.mdi.v-icon.notranslate.v-theme--default-upc.v-icon--size-default.text-primary")));
      openIcon.click();

      // Очікування появи заголовка "Details"
      WebElement detailsHeader =
          wait.until(
              ExpectedConditions.visibilityOfElementLocated(
                  By.xpath(
                      "//li[contains(@class, 'v-breadcrumbs-item--disabled') and .//a[text()='Details']]")));
  ...
  public boolean checkCreatedRate(
  ...
  public boolean toCreateExchangeRate(
      String currencyFrom, String currencyTo, String rate, String bank) {
    Waiters.appearElement(getDriver(), moneyTransferTab);
    moneyTransferTab.click();
  ...
  public boolean toDeleteExchangeRate(
      String currencyFrom, String currencyTo, String rate, String bank) {
    Waiters.appearElement(getDriver(), moneyTransferTab);
    moneyTransferTab.click();
    Waiters.appearElement(getDriver(), exchangeRate_tab);
