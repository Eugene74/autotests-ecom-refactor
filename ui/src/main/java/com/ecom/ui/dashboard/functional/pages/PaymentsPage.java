...
public class PaymentsPage extends BasePage {
  ...
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/main/div/form/div[1]/div[1]/div/div[1]/div/div[3]/div/input")
  ...
  @CacheLookup
  @FindBy(
      xpath = "(//label[contains(normalize-space(.), 'Card number')])[1]/following-sibling::input")
  ...
  @FindBy(
      xpath =
          "(//label[contains(normalize-space(.), 'Approval code')])[1]/following-sibling::input")
  ...
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/div[2]/div/div/div[1]/div/form/div[1]/div[1]/div/div/div/div/ul")
  ...
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/div[2]/div/div/div[2]/div[1]/div/div/div[1]/div/div[2]/div[1]/table/tbody/tr[1]/td[2]")
  ...
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/div[2]/div/div/div[2]/div[1]/div/div/div[1]/div/div[2]/div[1]/table/tbody/tr[5]/td[2]")
  ...
  @FindBy(
      xpath =
          "/html/body/div[2]/div/div[2]/form/div/div[3]/div/div[1]/div/div/div[1]/div/div[3]/input")
  protected WebElement reversalAmount_input;

  @CacheLookup
  @FindBy(
      xpath = "/html/body/div[2]/div/div[2]/form/div/div[3]/div[1]/div/div/div[1]/div/div[3]/input")
  protected WebElement fastrefundAmount_input;

  @CacheLookup
  @FindBy(
      xpath =
          "/html/body/div[2]/div/div[2]/form/div/div[3]/div[2]/div/div/div[1]/div/div[3]/textarea")
  protected WebElement fastrefundReason_input;

  @CacheLookup
  @FindBy(
      css =
          "div.v-selection-control.v-radio input[type='radio'][aria-label='Enter a new card for refund']")
  ...
  @FindBy(
      xpath =
          "/html/body/div[1]/div/div/main/div/div/div[2]/div[2]/div/div/div[1]/div/div/div[2]/div/button/span[3]")
  ...
  @CacheLookup
  @FindBy(
      xpath = "/html/body/div[1]/div/div/main/div/div/div/div[3]/div/div/div[1]/div[1]/button[2]")
  protected WebElement stopList_btn;

  @CacheLookup
  @FindBy(
      xpath =
          "/html/body/div[2]/div/div[2]/form/div/div[3]/div/div[1]/div/div/div[1]/div/div[3]/div")
  protected WebElement slModalExp_input;

  @CacheLookup
  @FindBy(
      xpath =
          "/html/body/div[2]/div/div[2]/form/div/div[3]/div/div[1]/div/div/div[1]/div/div[3]/div/input")
  protected WebElement slModalExp_ul;

  @CacheLookup
  @FindBy(
      xpath =
          "/html/body/div[2]/div/div[2]/form/div/div[3]/div/div[2]/div/div/div[1]/div/div[3]/textarea")
  ...
  public boolean findTranByMultFields(
  ...
  public void doReversalFR(String trackingId, String tranID) {
    ...
    try {
      ...
      String formattedAmount =
          String.format(Locale.US, "%.2f", amount); // Форматируем до 2 знаков после точки
  ...
  public void doFastRefund(String trackingId, String tranID) {
    ...
    try {
      // refundLink = getDriver().findElement(By.xpath("//td/div/a[contains(@class, 'link') and
      // contains(text(), 'refunded')]"));
      refundLink =
          getDriver()
              .findElement(
                  By.xpath(
                      "//td/div/a[contains(@class, 'link') and contains(text(), 'returned')]"));
  ...
  public void doPartialFastRefund(String trackingId, String tranID) {
    ...
    String halfAmountStr =
        String.format(Locale.US, "%.1f", halfAmount); // Форматуємо з крапкою як роздільником
    ...
    if (files != null) {
      for (File file : files) {
        if (file.getName().contains("receipt")
            && file.getName().endsWith(".pdf")) { // Замініть "receipt" на частину назви файлу
          isFileDownloaded = true;
          break;
        }
      }
  ...
  public boolean putToStopList(String trackingId, String tranID) {
    ...
    try {
      dayOption =
          wait.until(
              ExpectedConditions.visibilityOfElementLocated(
                  By.xpath("//div[contains(@class, 'v-list-item-title') and text()='Day']")));
