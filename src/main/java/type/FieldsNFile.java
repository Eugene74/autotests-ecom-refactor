 ...
 * Tran_type 97 2 Transaction type (Appendix 1):
     05 – purchase, 25 - purchase reversal
     06 – credit, 26 - credit reversal
     07- cash, 27 - cash reversal
     08 – deposit, 28 - deposit reversal
     09 – purchase with cashback,
     29 - purchase with cashback reversal

 * Appr_src 105 1 Authorization code source
     1 - On-line
     3 - Off-line
     4 - voice authorization

 * Sb_cnvdate 214 8 Current year (YYYY) + Field 16 value (MMDD) from
     authorization response.
     If Field 16 is empty then space filled
     Example: 20200917

 * MCC_code 339 4 Merchant category code (ISO Merchant service code)
     For VISA Direct / MasterCard MoneySend transactions:
     '6012'(Visa)/'6538',’4829’*,’6540’*(MasterCard) -
     Funding transaction;
     '6012'(Visa)/'6536'(MasterCard intracountry)/'6537'
     (MasterCard /intercountry) – Payment transaction
     * - MasterCard allows these MCC values from
     05.11.2019

 * FLD_123_1 883 1 CVV2 Result Code (BASEII)
     For Visa transactions:
     Space – no info
     M – CVV2 matched,
     N – CVV2 not matched,
     P – not processed,
     S – accepter does not find CVV2 on card,
     U – issuer is not certified.

* FLD_123_1 883 1 CVV2 Result Code (BASEII)

 * FLD_095
    * Field 63 or Field 104, Dataset 01, tag 01 or tag 02
        0003 = Issuer Reference Data
        Example: “0003009MSI2VB5XX“
    * Field 104 Dataset 01 tag 0F
        VARC = Visa Additional Reason Code
        Example: “VARC001V“
