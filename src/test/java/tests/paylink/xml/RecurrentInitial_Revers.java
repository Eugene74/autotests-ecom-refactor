...
public class RecurrentInitial_Revers extends BaseTest {
    ...
    public void RecurrentInitial() {
        requestDoc = paymentRecurent(cardMC, "recurrent rev", merchant_AVAL, terminal_AVAL, "true");
...
//        from DB
    ...
    public void RecurrentInitialRevers() {
