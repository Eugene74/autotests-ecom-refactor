...
public class PaymentFull3DS_Refund extends BaseTest {
    ...
    public void mcPaymentFull3DS(){
        requestDoc = paymentPares(cardMC05, "MasterCardPaymentFull3DS+Refund", merchant_AVAL, terminal_AVAL);
...
//        assertEquals(getValueFromTRAN(tranId, "FEE"), "400", "FEE");
    ...
    public void mcPaymentFull3DSRefund() {
