...
public class PreAuthorizationPostFull3DS extends BaseTest {
    ...
    public void PreAuthorization() {
        requestDoc = paymentPreAuthPares(cardMC, "pre auth f", merchant_AVAL, terminal_AVAL);
...
//        assertEquals(getValueFromTRAN(tranId, "FEE"), "400", "FEE");
    ...
    public void PreAuthorizationPost() {
        Document requestPostAuth = paymentPostAuth(requestDoc, responseDoc, "post auth", 0);
