...
public class CardToCardAttemptMasterVisa extends BaseTestMoneyTransfer {

    @Test
    public void transferCardToCard() {
        Document requestDoc = MoneyTransferRequests.transferCardToCardPares(cardMCmta, cardVISAmt, merchant_AVAL, terminal_AVAL);
        ...
        softAssertion.assertEquals(getValueFromMTTran(rrnFunding, "ECI"), "01", "ECI Funding");
        softAssertion.assertEquals(getValueFromMTTran(rrnFunding, "PAResStatus"), "A", "PAResStatus");
        softAssertion.assertEquals(getValueFromMTTran(rrnFunding, "PA_ECI"), "01", "PA_ECI");
