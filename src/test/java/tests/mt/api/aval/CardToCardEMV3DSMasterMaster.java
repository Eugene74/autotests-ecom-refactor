...
public class CardToCardEMV3DSMasterMaster extends BaseTestMoneyTransfer {

    @Test
    public void transferCardToCard() {
        Document requestDoc = MoneyTransferRequests.transferCardToCardEMV(cardMCmt, cardMCmt, merchant_AVAL, terminal_AVAL);
