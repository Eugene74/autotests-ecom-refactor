...
public class CardToCardMasterMaster extends BaseTestMoneyTransfer {

    @Test
    public void transferCardToCard() {
        Document requestDoc = MoneyTransferRequests.transferCardToCard(cardMCmt, cardMCmt, merchant_AVAL, terminal_AVAL);
