...
public class MoneyTransferPage2 extends MoneyTransferPage {
    public MoneyTransferPage2(WebDriver driver) {
        super(driver);

    }
    @Override
    public String toString() {
        return "001-rb-albania";
    }
    ...
    @FindBy(xpath = "/html/body/div[2]/div/main/div[2]/div/div/section[1]/label[2]/div/input")
