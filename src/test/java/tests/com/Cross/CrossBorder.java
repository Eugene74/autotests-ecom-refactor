...
public class CrossBorder {
    ...
    public void setUp() throws IOException {
        ...
        File endpointsFile = new File("properties/env.properties");
        File cardsFile = new File("properties/cards.properties");

        try (FileInputStream endpointsStream = new FileInputStream(endpointsFile);
             FileInputStream cardsStream = new FileInputStream(cardsFile)) {
            properties.load(endpointsStream);
            properties.load(cardsStream);
        }
