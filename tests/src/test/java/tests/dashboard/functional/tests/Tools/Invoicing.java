...
public class Invoicing extends BaseUiTest {
  ...
  public void setParam() {
    ...
    setMerchantAtt(ID_AVAL_4, ALLOW_PAYMENT_WITHOUT_3DS, "true");
    setMerchantAtt(ID_AVAL_4, MERCHANT_INVOICING_URL, URL_INVOCING);
  ...
  public void invoice_sms() {
    ...
    String source_text =
        emailsPage
            .openEmail(phone_number + "@sms.101.sms.upc.smpp", URL_MAIL_DEV, PIPELINE_NAME)
            .get_source_text();
    ...
    Assert.assertEquals(
        ...
        "Header '"
            + "Content-Type"
            + "' should appear exactly once in source: '"
            + source_text
            + "'");
  ...
  public void setDefaultParam() {
    ...
    setMerchantAtt(ID_AVAL_4, ALLOW_PAYMENT_WITHOUT_3DS, "false");
