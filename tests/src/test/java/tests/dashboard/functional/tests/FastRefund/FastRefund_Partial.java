...
public class FastRefund_Partial extends BaseUiTest {
  ...
  public void makePayment() {
    Document requestDoc =
        payment(cardVISAmtRev, "payment FastRefund", MERCHANT_ID_AVAL, TERMINAL_ID_AVAL);
  ...
  public void makePartialFastRefund() {
    ...
    softAssertion.assertEquals(
        getValueFromMTTranFR(refundIdFromDB, "CL_TYPE"), "VISA_FAST_REFUND", "CL_TYPE");
