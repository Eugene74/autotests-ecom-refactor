...
public class MdesVtsXMLApi extends BaseApiTest {
  ...
  public void testCreateToken(String cardName) throws Exception {
    ...
    String xmlData =
        requests.prepareCreateTokenRequest(
            ...
            MERCHANT_ID_AVAL_5,
            TERMINAL_ID_AVAL_5);
    HttpResponse response = sendPostRequest(URL_MDES_VTS_CREATE_TOKEN, xmlData);
  ...
  public void testRefreshToken(String cardName) throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_MDES_VTS_REFRESH_TOKEN, xmlData);
    String responseXml = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
  ...
  public void testCardMetaData(String cardName) throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_MDES_VTS_CARD_METADATA, xmlData);
    String responseXml = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
  ...
  public void testCardContent(String cardName) throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_MDES_VTS_CARD_CONTENT, xmlData);
    String responseXml = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
  ...
  public void testTokenStatus(String cardName) throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_MDES_VTS_TOKEN_STATUS, xmlData);
    String responseXml = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
  ...
  public void testTokenSuspend(String cardName) throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_MDES_VTS_TOKEN_SUSPEND, xmlData);
    String responseXml = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
  ...
  public void testTokenResume(String cardName) throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_MDES_VTS_TOKEN_RESUME, xmlData);
    String responseXml = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
  ...
  public void testTokenDelete(String cardName) throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_MDES_VTS_TOKEN_DELETE, xmlData);
    String responseXml = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
