...
public class GetItem extends BaseTestStopList {
  ...
  public void getItemPan(
      String merchantId, String terminalId, String trackingId, String stopListId) {
    Document requestDoc =
        RequestsStoplist.getItemPanDocument(merchantId, terminalId, trackingId, stopListId);
    ...
    assertEquals(
        getElementFromDocument(responseDoc, "type"),
    ...
    assertEquals(
        getElementFromDocument(responseDoc, "expDate"),
        ConfigStoplist.getProperty("stoplist.create.item.expDate"),
        "expDate");
    assertEquals(
        getElementFromDocument(responseDoc, "remark"),
        ConfigStoplist.getProperty("stoplist.create.item.createRemark"),
        "remark");
    assertEquals(
        getElementFromDocument(responseDoc, "created"),
