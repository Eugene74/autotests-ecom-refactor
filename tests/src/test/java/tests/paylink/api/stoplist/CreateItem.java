...
public class CreateItem extends BaseTestStoplist{
    ...
    public void createItemPan(String merchantId, String terminalId, String trackingId, String type, String pan, String expDate, String createRemark, String createDate){
        Document requestDoc = RequestsStoplist.createItemPanDocument(merchantId, terminalId, trackingId, type, pan, expDate, createRemark, createDate);
