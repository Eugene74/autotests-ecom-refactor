...
import static com.ecom.core.config.EnvData.ID_FACIL_AVAL;
...
public class Facilitator_Refund {
  ...
  public void FacilitatorPay() {
    requestDoc = payment(cardMC, "ref", MERCHANT_ID_FACIL_AVAL, TERMINAL_ID_FACIL_AVAL);
  ...
  public void generateBatch() {
    ...
    paylinkCloseDayForApi(ID_FACIL_AVAL);
