...
public class Voice_Refund {
  ...
  public void mcPaymentVoice() {
    requestDoc = payment(cardMC07, "MCVoice+Refund", MERCHANT_ID_AVAL, TERMINAL_ID_AVAL);
  ...
  public void mcPaymentVoiceRefund() {
    ...
    assertEquals(
        getValueFromTRAN(tranRefundId, "ECI"), JDBCMethods.getValueFromTRAN(tranId, "ECI"), "ECI");
