...
public class PaymentAttempt {
  ...
  public void mcPaymentAttempt() {
    Document requestDoc =
        paymentPares(cardMC06, "MasterCardPaymentAttempt", MERCHANT_ID_AVAL, TERMINAL_ID_AVAL);
  ...
  public void addTransactionRecordsToCheckNfile(
      Document requestDoc, int tranID, String approvalCode, String rrn, String[] card) {
    ...
    fieldValues.add(new FieldValue(Merchant, MERCHANT_ID_AVAL));
    ...
    fieldValues.add(new FieldValue(Term_nr, TERMINAL_ID_AVAL));
    fieldValues.add(new FieldValue(MerchantCode, fillFieldValue(MERCHANT_ID_AVAL, 15, ' ')));
    ...
    tagValues.add(
        new TagValue(
            Mtid16_SAAV, fillFieldValue(String.valueOf(card[5].length()), 3, '0') + card[5]));
    tagValues.add(
        new TagValue(
            Mtid16_CAVV, fillFieldValue(String.valueOf(card[5].length()), 3, '0') + card[5]));

    ECommTransaction eCommTransaction =
        new ECommTransaction(
