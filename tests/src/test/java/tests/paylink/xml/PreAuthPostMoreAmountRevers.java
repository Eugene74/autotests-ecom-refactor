...
public class PreAuthPostMoreAmountRevers extends BaseTest {
    private static Document requestDoc;
    private static Document responseDoc;
    private static Document requestPostAuth;
    private static int tranId;

    @Test
    public void PreAuthorization() {
        requestDoc = paymentPreAuth(cardMC07, "pre post more r", merchant_AVAL, terminal_AVAL);
...
//        assertEquals(getValueFromTRAN(tranId, "FEE"), "400", "FEE");
    ...
    public void PreAuthorizationPostMoreAmountRevers() {
