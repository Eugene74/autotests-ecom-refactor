...
public class Tmp {
  ...
  public void test() throws SQLException {
    ...
    int beginIndexOfSendedIsoMsg =
        remaindedMsgPart.indexOf(SENDED_ISO_MSG_TITLE) + SENDED_ISO_MSG_TITLE.length();
    int endIndexOfSendedIsoMsg =
        remaindedMsgPart.indexOf(ISO_MSG_TAG_CLOSE) + ISO_MSG_TAG_CLOSE.length();

    String sendedIsoMsg =
        remaindedMsgPart.substring(beginIndexOfSendedIsoMsg, endIndexOfSendedIsoMsg);
    ...
    int beginIndexOfReceivedIsoMsg =
        remaindedMsgPart.indexOf(RECEIVED_ISO_MSG_TITLE) + RECEIVED_ISO_MSG_TITLE.length();
    int endIndexOfReceivedIsoMsg =
        remaindedMsgPart.indexOf(ISO_MSG_TAG_CLOSE) + ISO_MSG_TAG_CLOSE.length();
    String receivedIsoMsg =
        remaindedMsgPart.substring(beginIndexOfReceivedIsoMsg, endIndexOfReceivedIsoMsg);
  ...
  public void test2() throws SQLException {
    ...
    String s =
        "https://moja.tatrabanka.sk/3dsecure/3d-secure?acsTransId=2/863303cc-b3d0-4c2e-8260-f73c3d40a5e1/";
