...
public class PaymentAttempt_Refund extends BaseTest {
    ...
    public void mcPaymentAttempt(){
        requestDoc = paymentPares(cardMC06, "MasterCardPaymentAttempt+Refund", merchant_AVAL, terminal_AVAL);
...
//        assertEquals(getValueFromTRAN(tranId, "FEE"), "400", "FEE");
    ...
    public void mcPaymentAttemptRefund() {
