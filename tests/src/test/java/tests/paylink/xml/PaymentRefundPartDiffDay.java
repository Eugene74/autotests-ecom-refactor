...
public class PaymentRefundPartDiffDay {
  ...
  public void Payment() {
    requestDoc =
        payment(cardMC, "payment+refund_part_diff_days", MERCHANT_ID_AVAL, TERMINAL_ID_AVAL);
  ...
  public void PaymentRefundPartFirstDay() {
    ...
    assertEquals(
        getValueFromTRAN(tranRefundFirstId, "ECI"), getValueFromTRAN(tranPayId, "ECI"), "ECI");
  ...
  public void PaymentRefundPartOtherDay() {
    ...
    assertEquals(
        getValueFromTRAN(tranRefundSecondId, "ECI"), getValueFromTRAN(tranPayId, "ECI"), "ECI");
  ...
  public void addDataToCheckTransactionRefundNFile(
      Document requestRevDoc, Document responseRevDoc, int tranID) {
