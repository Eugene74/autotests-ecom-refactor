...
public class CardToCardFull3DSMasterVisa {

    @Test
    public void transferCardToCard() {
        Document requestDoc = MoneyTransferRequests.transferCardToCardPares(cardMCmt, cardVISA, merchant_AVAL, terminal_AVAL);
