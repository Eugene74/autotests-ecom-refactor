...
import static com.ecom.tests.support.MoneyTransferRequests.fastRefundAPI;
...
public class FastRefund_ApprovalCode_RRN {
  ...
  public void makePayment() {
    Document requestDoc =
        payment(cardMCmt, "payment FastRefund", MERCHANT_ID_AVAL, TERMINAL_ID_AVAL);
    ...
    totalAmountFromPayment =
        getElementFromDocument(requestDoc, "TotalAmount"); // Сохраняем TotalAmount
  ...
  public void makeFastRefund() {
    Document requestRFDoc =
        fastRefundAPI(MERCHANT_ID_AVAL, TERMINAL_ID_AVAL, requestDoc, responseDoc);
