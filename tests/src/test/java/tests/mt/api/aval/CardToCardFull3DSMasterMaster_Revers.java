...
public class CardToCardFull3DSMasterMaster_Revers {
  ...
  public void transferCardToCardFull3DS() {
    requestDoc =
        MoneyTransferRequests.transferCardToCardPares(
            cardMCmt, cardMCmt, MERCHANT_ID_AVAL, TERMINAL_ID_AVAL);
  ...
  public void reversOnFundingCardToCardFull3DS() {
    ...
    SoftAssert softAssertion = new SoftAssert();
    // softAssertion.assertEquals("1", getValueFromMTTran(rrnReversal, "Reversed"),
    // "Reversed");//зміна черги
