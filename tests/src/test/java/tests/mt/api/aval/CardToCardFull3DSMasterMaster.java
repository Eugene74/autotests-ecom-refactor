...
public class CardToCardFull3DSMasterMaster extends BaseTestMoneyTransfer {

    @Test
    public void transferCardToCard() {
        Document requestDoc = MoneyTransferRequests.transferCardToCardPares(cardMCmt, cardMCmt, merchant_AVAL, terminal_AVAL);
