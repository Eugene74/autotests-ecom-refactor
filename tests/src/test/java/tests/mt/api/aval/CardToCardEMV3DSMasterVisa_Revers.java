...
public class CardToCardEMV3DSMasterVisa_Revers extends BaseTestMoneyTransfer {
    protected Document requestDoc;
    protected Document responseDoc;

    @Test
    public void transferCardToCardEMV() {
        requestDoc = MoneyTransferRequests.transferCardToCardEMV(cardMCmt, cardVISAmt, merchant_AVAL, terminal_AVAL);
