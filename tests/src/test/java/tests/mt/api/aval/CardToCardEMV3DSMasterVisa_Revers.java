...
public class CardToCardEMV3DSMasterVisa_Revers {
  protected Document requestDoc;
  protected Document responseDoc;

  @Test
  public void transferCardToCardEMV() {
    requestDoc =
        MoneyTransferRequests.transferCardToCardEMV(
            cardMCmt, cardVISAmt, MERCHANT_ID_AVAL, TERMINAL_ID_AVAL);
    ...
    String[] verifiedResponseFromDBFunding = {
      "ECI", "PAResStatus", "PA_ECI", "Version3DS", "DS_TransID"
    };
  ...
  @Test(dependsOnMethods = "transferCardToCardEMV")
  public void reversOnFundingCardToCardEMV() {
