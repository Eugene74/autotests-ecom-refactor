...
public class P2P_FundingMCPaymenVisa extends BaseUiTest {
  ...
  public void transferFromMCFullToVISA(String merchantId, Class<? extends BasePage> pageClass)
      throws Exception {
    ...
    requestId =
        moneyTransfer.domesticTransfer(
            merchantIdInt, cardMCmt, cardVISArec, (Class<? extends MoneyTransferPage>) pageClass);
    ...
    softAssertion.assertEquals(
        getValueFromMTTran(rrn_funding, "ApprovalCode").length(), 6, "F_ApprovalCode");
    ...
    softAssertion.assertEquals(
        getValueFromMTTran(rrn_payment, "ApprovalCode").length(), 6, "P_ApprovalCode");
    ...
    String[] verifiedResponseFromDBFunding = {
      "ECI", "ApprovalCode", "MCC", "Code", "CVResult", "RRN"
    };
