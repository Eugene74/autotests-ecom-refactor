...
import static com.ecom.core.config.EnvData.MERCHANT_ID_AVAL_5;
import static com.ecom.core.config.EnvData.TERMINAL_ID_AVAL_5;
import static com.ecom.core.config.EnvData.URL_TOMCAT;
import static org.testng.Assert.assertEquals;
import static org.testng.Assert.assertNotNull;

import com.ecom.tests.base.CrossBaseTestXML;
...
public class CrossBorderXML extends CrossBaseTestXML {
  ...
  public void sendXmlRequest() throws Exception {
    ...
    params.put("Merchant3ID", MERCHANT_ID_AVAL_5);
    params.put("Terminal3ID", TERMINAL_ID_AVAL_5);
  ...
  private String verifyXmlResponse(String xml, SoftAssert softAssertion) throws Exception {
    ...
    String statusCode =
        statusCodeNodes.getLength() > 0 ? statusCodeNodes.item(0).getTextContent().trim() : "";
    ...
    String trackingId =
        trackingIdNodes.getLength() > 0 ? trackingIdNodes.item(0).getTextContent().trim() : "";
