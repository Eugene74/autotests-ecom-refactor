...
public class KafdropEmail extends BaseUiTest {
      ...
      WebElement dataRow =
          wait.until(
              ExpectedConditions.visibilityOfElementLocated(
                  By.xpath("//tr[@class='dataRow']/td/a[contains(@href, '" + pipelineId + "')]")));
        ...
        try {
          ...
          WebElement viewMessagesButton =
              wait.until(
                  ExpectedConditions.visibilityOfElementLocated(
                      By.xpath(
                          "//a[@id='topic-messages' and contains(@href, 'emailUPC-"
                              + pipelineId
                              + "')]")));
        ...
        try {
          ...
          for (WebElement messageDetail : messageDetails) {
            try {
              ...
              if (messageText.contains("viacheslav.yarosh@upc.ua")
                  || messageText.contains("Viacheslav.Yarosh@upc.ua")) {
