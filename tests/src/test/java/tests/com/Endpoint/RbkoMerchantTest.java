...
public class RbkoMerchantTest extends BaseTest {

    @BeforeClass
    public void setup() {
        super.setup();
        driver.get(baseUrl + "/rbko/merchant");
    }
   ...
   public void teardown() {
    ...
    @Test(groups = "rbko-merchant-tests")
    ...
    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyPageTitle")
    ...
    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyLoginSuccess")
    public void verifyTabExistence() {
        // Використання явного очікування для того, щоб елемент завантажився
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/rbko/merchant/index.jsp']")));

        // Перевірка, що елемент не є null
        assertNotNull(tab);
    }

    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyTabExistence")
    public void verifyTabNavigation() {
        // Click on the tab
       // WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/rbko/merchant/index.jsp']")));
        tab.click();

        // Use explicit wait to wait for the tab to become active
        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/rbko/merchant/index.jsp' and contains(@class, 'menuSelected')]")));
        assertNotNull(activeTab);
    }

    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyTabNavigation")
    public void verifyProfilExistence() {
        // Використання явного очікування для того, щоб елемент завантажився
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement profileTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/rbko/merchant/do?action=profile']")));

        // Перевірка, що елемент не є null
        assertNotNull(profileTab);
    }

    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyProfilExistence")
    public void verifyProfilNavigation() {
        // Використання явного очікування для того, щоб елемент завантажився
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/rbko/merchant/do?action=profile']")));
        tab.click();

        // Використовуємо явне очікування, щоб дочекатися, коли вкладка стане активною
        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/rbko/merchant/do?action=profile' and contains(@class, 'menuSelected')]")));
        assertNotNull(activeTab);
    ...
    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyProfilNavigation")
    public void verifyTerminalExistence() {
        // Використання явного очікування для того, щоб елемент завантажився
      //  WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement terminalTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/rbko/merchant/do?action=terminals']")));

        // Перевірка, що елемент не є null
        assertNotNull(terminalTab);
    }

    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyTerminalExistence")
    public void verifyTerminalNavigation() {
        // Використання явного очікування для того, щоб елемент завантажився
      //  WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/rbko/merchant/do?action=terminals']")));
        tab.click();

        // Використовуємо явне очікування, щоб дочекатися, коли вкладка стане активною
        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/rbko/merchant/do?action=terminals' and contains(@class, 'menuSelected')]")));
        assertNotNull(activeTab);
    ...
    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyTerminalNavigation")
    public void verifyTransExistence() {
        // Використання явного очікування для того, щоб елемент завантажився
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement transTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/rbko/merchant/do?action=trans']")));
    ...
    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyTransExistence")
    public void verifyInvoicingExistence() {
        // Використання явного очікування для того, щоб елемент завантажився
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement invoicingTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/rbko/merchant/do?action=invoicing']")));

        // Перевірка, що елемент не є null
        assertNotNull(invoicingTab);
    }

    @Test(groups = "rbko-merchant-tests", dependsOnMethods = "verifyInvoicingExistence")
    public void verifyInvoicingNavigation() {
       // WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));

        // Натискаємо на вкладку "Invoicing"
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/rbko/merchant/do?action=invoicing']")));
        tab.click();

        // Очікуємо, поки вкладка стане активною
        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/rbko/merchant/do?action=invoicing' and contains(@class, 'menuSelected')]")));
        assertNotNull(activeTab);
        ...
        descriptionInput.sendKeys("RBKOInvoicing");
...
// Знайти <td> елемент, який містить кілька можливих текстів, і отримати наступний <td> елемент
        ...
        WebElement invoicingTab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='menuUnselected' and @href='/rbko/merchant/do?action=invoicing']")));
        invoicingTab.click();
