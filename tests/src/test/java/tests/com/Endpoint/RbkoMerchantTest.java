...
public class RbkoMerchantTest extends EndpointBaseTest {
  @BeforeClass(alwaysRun = true)
  public void openMerchantPage() {
    driver.get(URL_TOMEE + "/rbko/merchant");
  }
  ...
  public void verifyTabExistence() {
    ...
    WebElement tab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbko/merchant/index.jsp']")));
  ...
  public void verifyTabNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/rbko/merchant/index.jsp' and contains(@class, 'menuSelected')]")));
  ...
  public void verifyProfilExistence() {
    ...
    WebElement profileTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbko/merchant/do?action=profile']")));
  ...
  public void verifyProfilNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/rbko/merchant/do?action=profile' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);
  ...
  public void verifyTerminalExistence() {
    ...
    WebElement terminalTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbko/merchant/do?action=terminals']")));
  ...
  public void verifyTerminalNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/rbko/merchant/do?action=terminals' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);
  ...
  public void verifyTransExistence() {
    ...
    WebElement transTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbko/merchant/do?action=trans']")));
  ...
  public void verifyInvoicingExistence() {
    ...
    WebElement invoicingTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbko/merchant/do?action=invoicing']")));
  ...
  public void verifyInvoicingNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/rbko/merchant/do?action=invoicing' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);
    ...
    WebElement orderIdTd =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//td[contains(text(), 'Order ID') or contains(text(), 'Kodi i porosisë') or contains(text(), 'ID замовлення')"
    ...
    WebElement invoicingTab =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath(
                    "//a[@class='menuUnselected' and @href='/rbko/merchant/do?action=invoicing']")));
    invoicingTab.click();
    ...
    WebElement searchButton =
        driver.findElement(By.xpath("//*[@id=\"searchData\"]/tbody/tr[6]/td/input"));
    searchButton.click();
