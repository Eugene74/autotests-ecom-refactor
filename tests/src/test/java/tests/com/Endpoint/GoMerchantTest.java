...
public class GoMerchantTest extends BaseTest {
    ...
    public void verifyTabExistence() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/index.jsp']")));
    ...
    public void verifyTabNavigation() {
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/go/merchant/index.jsp']")));
        tab.click();

        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/index.jsp' and contains(@class, 'menuSelected')]")));
    ...
    public void verifyProfilExistence() {
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement profileTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=profile']")));
    ...
    public void verifyProfilNavigation() {
        ...
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/go/merchant/do?action=profile']")));
        tab.click();

        // Використовуємо явне очікування, щоб дочекатися, коли вкладка стане активною
        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=profile' and contains(@class, 'menuSelected')]")));
    ...
    public void verifyTerminalExistence() {
       ...
       // WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement terminalTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=terminals']")));
    ...
    public void verifyTerminalNavigation() {
        ...
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/go/merchant/do?action=terminals']")));
        tab.click();

        // Використовуємо явне очікування, щоб дочекатися, коли вкладка стане активною
        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=terminals' and contains(@class, 'menuSelected')]")));
        assertNotNull(activeTab);
    ...
    public void verifyTransExistence() {
        ...
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement transTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=trans']")));
    ...
    public void verifyCodeErrorExistence() {
        ...
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement codeErrorTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=tranErrorList']")));

        // Перевірка, що елемент не є null
        assertNotNull(codeErrorTab);
    }

    @Test(groups = "go-merchant-tests", dependsOnMethods = "verifyCodeErrorExistence")
    public void verifyCodeErrorNavigation() {
        // Використання явного очікування для того, щоб елемент завантажився
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/go/merchant/do?action=tranErrorList']")));
        tab.click();

        // Використовуємо явне очікування, щоб дочекатися, коли вкладка стане активною
        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=tranErrorList' and contains(@class, 'menuSelected')]")));
        assertNotNull(activeTab);

        // Використовуємо явне очікування для появи тексту 000 = Approved
        WebElement errorText = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//td[text()='000 = Approved']")));
    ...
    @Test(groups = "go-merchant-tests", dependsOnMethods = "verifyCodeErrorNavigation")
    public void verifyStopListExistence() {
        // Використання явного очікування для того, щоб елемент завантажився
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement stopListTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=viewStopList']")));

        // Перевірка, що елемент не є null
        assertNotNull(stopListTab);
    }

    @Test(groups = "go-merchant-tests", dependsOnMethods = "verifyStopListExistence")
    public void verifyStopListNavigation() {
        // Використання явного очікування для того, щоб елемент завантажився
       // WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/go/merchant/do?action=viewStopList']")));
        tab.click();

        // Використовуємо явне очікування, щоб дочекатися, коли вкладка стане активною
        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=viewStopList' and contains(@class, 'menuSelected')]")));
        assertNotNull(activeTab);

        // Логування для підтвердження
        System.out.println("StopList: Ok");
    }
    ...
    public void verifyInvoicingExistence() {
        ...
        //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement invoicingTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=invoicing']")));
    ...
    public void verifyInvoicingNavigation() {
        ...
        WebElement tab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/go/merchant/do?action=invoicing']")));
        tab.click();

        // Очікуємо, поки вкладка стане активною
        WebElement activeTab = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@href='/go/merchant/do?action=invoicing' and contains(@class, 'menuSelected')]")));
        assertNotNull(activeTab);
        ...
        descriptionInput.sendKeys("GOInvoicing");
        ...
        WebElement invoicingTab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='menuUnselected' and @href='/go/merchant/do?action=invoicing']")));
        invoicingTab.click();
