...
public class GoMerchantTest extends EndpointBaseTest {
  @BeforeClass(alwaysRun = true)
  public void openMerchantPage() {
    driver.get(URL_TOMEE + "/go/merchant");
  }
  ...
  public void verifyPageTitle() {
    ...
    assertEquals(
        actualTitle, expectedTitle); // Перевірка, що заголовок сторінки відповідає очікуваному
  }
  ...
  public void verifyLoginSuccess() {
    ...
    WebElement loginButton =
        driver.findElement(By.xpath("//*[@id='content']/form/table/tbody/tr[3]/td[2]/input"));
    loginButton.click();
  ...
  public void verifyTabExistence() {
    ...
    WebElement tab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/go/merchant/index.jsp']")));
  ...
  public void verifyTabNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/go/merchant/index.jsp' and contains(@class, 'menuSelected')]")));
  ...
  public void verifyProfilExistence() {
    ...
    WebElement profileTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/go/merchant/do?action=profile']")));
  ...
  public void verifyProfilNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/go/merchant/do?action=profile' and contains(@class, 'menuSelected')]")));
  ...
  public void verifyTerminalExistence() {
    ...
    WebElement terminalTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/go/merchant/do?action=terminals']")));
  ...
  public void verifyTerminalNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/go/merchant/do?action=terminals' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);
    ...
    WebElement terminalGetTab =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath("//a[@href='?action=terminalGet&merchantId=" + ID_AVAL_1 + "']")));
  ...
  public void verifyTransExistence() {
    ...
    WebElement transTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/go/merchant/do?action=trans']")));
  ...
  public void verifyCodeErrorExistence() {
    ...
    WebElement codeErrorTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/go/merchant/do?action=tranErrorList']")));
  ...
  public void verifyCodeErrorNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/go/merchant/do?action=tranErrorList' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);

    // Використовуємо явне очікування для появи тексту 000 = Approved
    WebElement errorText =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(By.xpath("//td[text()='000 = Approved']")));
  ...
  public void verifyStopListExistence() {
    // Використання явного очікування для того, щоб елемент завантажився
    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    WebElement stopListTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/go/merchant/do?action=viewStopList']")));
  ...
  public void verifyStopListNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/go/merchant/do?action=viewStopList' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);
  ...
  public void verifyInvoicingExistence() {
    ...
    WebElement invoicingTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/go/merchant/do?action=invoicing']")));
  ...
  public void verifyInvoicingNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/go/merchant/do?action=invoicing' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);
    ...
    // Знаходимо і запам'ятовуємо значення з <td> елемент, який містить текст "ID", та наступний
    // <td> елемент
    ...
    WebElement invoicingTab =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath(
                    "//a[@class='menuUnselected' and @href='/go/merchant/do?action=invoicing']")));
    invoicingTab.click();
  ...
  private void checkFileDownloaded(String expectedFileName) {
    ...
    assertTrue(
        ...
        "Downloaded file '"
            + expectedFileName
            + "' does not exist."); // Перевірка існування завантаженого файлу
