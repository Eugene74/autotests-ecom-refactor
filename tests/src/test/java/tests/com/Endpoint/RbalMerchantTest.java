...
public class RbalMerchantTest extends EndpointBaseTest {

  @BeforeClass(alwaysRun = true)
  public void openMerchantPage() {
    driver.get(URL_TOMEE + "/rbal/merchant");
  }
  ...
  public void verifyLoginSuccess() {
    ...
    WebElement loginButton =
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/ul/li[3]/div[1]/button"));
    loginButton.click();
  ...
  public void verifyTabExistence() {
    ...
    WebElement tab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbal/merchant/index.jsp']")));
  ...
  public void verifyTabNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/rbal/merchant/index.jsp' and contains(@class, 'menuSelected')]")));
  ...
  public void verifyProfilExistence() {
    ...
    WebElement profileTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbal/merchant/do?action=profile']")));
  ...
  public void verifyProfilNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/rbal/merchant/do?action=profile' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);
  ...
  public void verifyTerminalExistence() {
    ...
    WebElement terminalTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbal/merchant/do?action=terminals']")));
  ...
  public void verifyTerminalNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/rbal/merchant/do?action=terminals' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);
  ...
  public void verifyTransExistence() {
    ...
    WebElement transTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbal/merchant/do?action=trans']")));
  ...
  public void verifyInvoicingExistence() {
    ...
    WebElement invoicingTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbal/merchant/do?action=invoicing']")));
  ...
  public void verifyInvoicingNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//a[@href='/rbal/merchant/do?action=invoicing' and contains(@class, 'menuSelected')]")));
    assertNotNull(activeTab);
    ...
    WebElement invoicingTab =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath(
                    "//a[@class='menuUnselected' and @href='/rbal/merchant/do?action=invoicing']")));
    invoicingTab.click();
