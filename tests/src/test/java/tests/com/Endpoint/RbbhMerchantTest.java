...
public class RbbhMerchantTest extends EndpointBaseTest {

  @BeforeClass(alwaysRun = true)
  public void openMerchantPage() {
    driver.get(URL_TOMEE + "/rbbh/merchant");
  }
  ...
  public void verifyTabExistence() {
    ...
    WebElement tab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbbh/merchant/index.jsp']")));
  ...
  public void verifyProfilExistence() {
    ...
    WebElement profileTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbbh/merchant/do?action=profile']")));
    // Перевірка, що елемент не є null
  ...
  public void verifyTerminalExistence() {
    ...
    WebElement terminalTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbbh/merchant/do?action=terminals']")));
  ...
  public void verifyTransExistence() {
    ...
    WebElement transTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbbh/merchant/do?action=trans']")));
    ...
    WebElement searchButton =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div/div/div/form/div/div[5]/div[1]/input")));
    searchButton.click();
  ...
  public void verifyInvoicingExistence() {
    ...
    WebElement invoicingTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbbh/merchant/do?action=invoicing']")));
  ...
  public void verifyInvoicingNavigation() {
    ...
    WebElement orderIdSpan =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//span[contains(text(), 'Order ID') or contains(text(), 'Broj narudžbe')"
    ...
    WebElement searchButton =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath("//input[@type='submit' and @value='Traži']")));
    searchButton.click();
