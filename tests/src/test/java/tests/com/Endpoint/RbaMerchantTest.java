...
public class RbaMerchantTest extends EndpointBaseTest {

  @BeforeClass(alwaysRun = true)
  public void openMerchantPage() {
    driver.get(URL_TOMEE + "/rba/merchant");
  }
  ...
  public void verifyTabExistence() {
    ...
    WebElement tab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rba/merchant/index.jsp']")));
  ...
  public void verifyProfilExistence() {
    ...
    WebElement profileTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rba/merchant/do?action=profile']")));
  ...
  public void verifyTerminalExistence() {
    ...
    WebElement terminalTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rba/merchant/do?action=terminals']")));
  ...
  public void verifyTerminalNavigation() {
    ...
    WebElement terminalIdLabel =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//span[@class='label' and (contains(text(), 'ID') or contains(text(), 'Kodi'))]")));

    // Знайти наступний <span> елемент з класом "value"
    WebElement terminalIdValue =
        terminalIdLabel.findElement(By.xpath("following-sibling::span[@class='value']"));
  ...
  public void verifyTransExistence() {
    ...
    WebElement transTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rba/merchant/do?action=trans']")));
    ...
    WebElement resultsTable =
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//tr/th[text()='ID']")));
    assertNotNull(resultsTable);

    // Натискання на кнопку "Експорт"
    //        WebElement exportButton =
    // wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@id='export' and
    // @class='export-table']")));
    //        exportButton.click();
  ...
  public void verifyInvoicingExistence() {
    ...
    WebElement invoicingTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rba/merchant/do?action=invoicing']")));
  ...
  public void verifyInvoicingNavigation() {
    ...
    //        wait.until(ExpectedConditions.urlToBe(invoicingUrl));  // закомічено для тесту на test
    // середовищі
    ...
    WebElement orderIdSpan =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//span[contains(text(), 'Order ID') or contains(text(), 'Kodi i porosisë')"
