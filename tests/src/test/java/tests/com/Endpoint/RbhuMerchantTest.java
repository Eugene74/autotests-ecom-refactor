...
public class RbhuMerchantTest extends EndpointBaseTest {

  @BeforeClass(alwaysRun = true)
  public void openMerchantPage() {
    driver.get(URL_TOMEE + "/rbhu/merchant");
  }
  ...
  public void verifyLoginSuccess() {
    ...
    WebElement loginButton =
        driver.findElement(By.xpath("/html/body/div/div/div/form/div/div[3]/input"));
    loginButton.click();
    ...
    WebElement welcomeMessage =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("/html/body/aside/nav/ul[1]/li[1]/a")));
  ...
  public void verifyTabExistence() {
    ...
    WebElement tab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbhu/merchant/index.jsp']")));
  ...
  public void verifyProfilExistence() {
    ...
    WebElement profileTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbhu/merchant/do?action=profile']")));
  ...
  public void verifyProfilNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//html/body/aside/nav/ul[1]/li[2]/a")));
    assertNotNull(activeTab);
    ...
    WebElement userCell =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("/html/body/div/div/div/div[1]/form/div/div[1]/div/span")));
  ...
  public void verifyTerminalExistence() {
    ...
    WebElement terminalTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbhu/merchant/do?action=terminals']")));
  ...
  public void verifyTerminalNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("/html/body/aside/nav/ul[1]/li[3]/a")));
    assertNotNull(activeTab);
    ...
    WebElement terminalGetTab =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath("//a[@href='?action=terminalGetWithUI&merchantId=" + merchantId + "']")));
    ...
    WebElement terminalIdValue =
        terminalIdLabel.findElement(By.xpath("/html/body/div/div/div/div/ul/li[1]/span[2]"));
  ...
  public void verifyTransExistence() {
    ...
    WebElement transTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbhu/merchant/do?action=trans']")));
    ...
    WebElement searchButton =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath("//*[@id=\"searchForm\"]/div/div[4]/div[1]/input")));
    searchButton.click();

    // WebElement resultsTable =
    // wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//table[@class='table
    // table-bordered table-striped']//th/a[contains(text(), 'ID')]")));
    // assertNotNull(resultsTable);

    WebElement collapseTrigger =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath("//a[@class='collapse-trigger expanded']")));
    collapseTrigger.click();

    // Клацаємо на поле <select name="merchantId">
    WebElement selectMerchantIdField =
        wait.until(
            ExpectedConditions.elementToBeClickable(By.xpath("//select[@name='merchantId']")));
    selectMerchantIdField.click();

    // Вибір merchantId з properties у <select name="merchantId">
    Integer merchantId = ID_AVAL_1;
    WebElement selectMerchantId =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(By.xpath("//select[@name='merchantId']")));
    WebElement optionMerchantId =
        selectMerchantId.findElement(By.xpath(".//option[@value='" + merchantId + "']"));
    optionMerchantId.click();

    // WebElement sucheButton =
    // wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='btn btn-primary'
    // and @type='submit' and @value='Suche']")));
    ...
    WebElement exportButton =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath("//a[@id='export' and @class='export-table']")));
    exportButton.click();
  ...
  public void verifyInvoicingExistence() {
    ...
    WebElement invoicingTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbhu/merchant/do?action=invoicing']")));
  ...
  public void verifyInvoicingNavigation() {
    ...
    String invoicingUrl = String.format("%s/rba/merchant/do?action=invoicing", URL_TOMEE);

    // Обираємо опцію "TestYVP2" у селекті "mid"
    WebElement selectMid =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//select[@name='mid' and @id='mid']")));
    ...
    Waiters.sleep(1000);
    WebElement orderIdSpan =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//span[contains(text(), 'Auftrag-ID') or contains(text(), 'Megrendelés azonosító')"
                        + " or contains(text(), 'Order ID') or contains(text(), 'ID заказа')]")));

    // Знайти наступний <span> елемент з класом "value"
    WebElement orderIdValueSpan =
        orderIdSpan.findElement(By.xpath("following-sibling::span[@class='value']"));
    Waiters.sleep(1000);
    ...
    // WebElement merchantIdSelect =
    // driver.findElement(By.xpath("//*[@id=\"searchForm\"]/div/div[1]/div[1]/div/div/div/div/div/select"));
    // WebElement merchantIdOption = merchantIdSelect.findElement(By.xpath(".//option[@value='" +
    // merchantId + "']"));
    ...
    WebElement merchantIdSelect =
        driver.findElement(
            By.xpath("//*[@id=\"searchForm\"]/div/div[1]/div[1]/div/div/div/div/div/select"));
    ...
    WebElement searchButton =
        wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath("//*[@id=\"searchForm\"]/div/div[3]/div[1]/input")));
    searchButton.click();
  ...
  public void verifyCodeErrorExistence() {
    ...
    // WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    WebElement codeErrorTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rbhu/merchant/do?action=tranErrorCodes']")));
  ...
  public void verifyCodeErrorNavigation() {
    ...
    WebElement activeTab =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath(
                    "//li[@class='active']/a[@href='/rbhu/merchant/do?action=tranErrorCodes']")));
    assertNotNull(activeTab);
    ...
    WebElement errorText =
        wait.until(
            ExpectedConditions.presenceOfElementLocated(
                By.xpath("//td[contains(text(), '000 = Approved')]")));
