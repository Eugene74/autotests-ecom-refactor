...
public class Service01_JSON {
  ...
  public void setUp() {
    ...
    log.info(
        "Loaded config: merchant={}, terminal={}, order={}",
        MERCHANT_ID_AVAL_1,
        TERMINAL_ID_AVAL_1,
        orderID);
  }
  ...
  public void shouldSendJsonAndValidateResponse() throws Exception {
    ...
    payload.put("merchantId", MERCHANT_ID_AVAL_1);
    payload.put("terminalId", TERMINAL_ID_AVAL_1);
    ...
    JSONObject result = new JSONObject(decoded).getJSONArray("results").getJSONObject(0);
