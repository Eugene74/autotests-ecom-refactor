...
import static com.ecom.core.config.EnvData.URL_ALIAS_2_GET_PAYMENT_CRED;
...
public class GetPaymentCredentialAlias2 extends BaseTestAlias2 {
  ...
  public void testGetPaymentCredentialAlias2() throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_ALIAS_2_GET_PAYMENT_CRED, xmlContent);
  ...
  private void verifyGetPaymentCredentialResponse(String xml, SoftAssert softAssertion)
      throws Exception {
    ...
    NodeList getPaymentCredentialResultNodes =
        doc.getElementsByTagName("GetPaymentCredentialResult");
    boolean isGetPaymentCredentialResultNotEmpty =
        getPaymentCredentialResultNodes.getLength() > 0
            && getPaymentCredentialResultNodes.item(0).getTextContent().trim().length() > 0;
    System.out.println(
        "GetPaymentCredentialResult is not empty: " + isGetPaymentCredentialResultNotEmpty);
    softAssertion.assertTrue(
        isGetPaymentCredentialResultNotEmpty, "<GetPaymentCredentialResult> is empty");
