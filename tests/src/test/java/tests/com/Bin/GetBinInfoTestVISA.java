...
import static com.ecom.core.config.XMLBinInfoResource.XML_GET_INFO_RESOURCE_VISA;
import static org.testng.Assert.assertEquals;
import static org.testng.Assert.assertNotNull;

public class GetBinInfoTestVISA extends BaseTestBinInfo {

    @Test
    public void testGetBinInfoForVISA() throws Exception {
        String xmlContent = getResourceContent(XML_GET_INFO_RESOURCE_VISA);
