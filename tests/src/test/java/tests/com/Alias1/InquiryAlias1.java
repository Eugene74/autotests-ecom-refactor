...
import static com.ecom.core.config.EnvData.URL_ALIAS_1_INGUIRY;
...
public class InquiryAlias1 extends BaseTestAlias1 {
  private String[] specificTags = {
    "MerchantId", "TerminalId", "Trackingid", "alias", "paymentInstrOwner"
  };
  ...
  public void testAliasInquiry() throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_ALIAS_1_INGUIRY, xmlContent);
