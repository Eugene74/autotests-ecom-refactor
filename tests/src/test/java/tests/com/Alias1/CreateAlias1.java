...
import static com.ecom.core.config.EnvData.URL_ALIAS_1_CREATE;
...
public class CreateAlias1 extends BaseTestAlias1 {
  private String[] specificTags = {"MerchantId", "TerminalId", "Trackingid", "guid", "updateAlias"};
  ...
  public void testCreateAlias1() throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_ALIAS_1_CREATE, xmlContent);
