...
import static com.ecom.core.config.EnvData.URL_ALIAS_1_GET;
import static com.ecom.core.config.XMLAliasResource.XML_GET_ALIAS1_RESOURCE;
...
public class GetAlias1 extends BaseTestAlias1 {
  private String[] specificTags = {
    "MerchantId", "TerminalId", "Trackingid", "guid",
  };
  ...
  public void testGetAlias1() throws Exception {
    ...
    HttpResponse response = sendPostRequest(URL_ALIAS_1_GET, xmlContent);
    ...
    printSpecificTags(maskedResponse, specificTags); // Друкуємо тільки теги
    verifyXmlResponse(maskedResponse, softAssertion, "guid");
