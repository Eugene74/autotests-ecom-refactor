...
public class RequestsOnboarding {
    ...
    public static Document createMerchantDocument(String MerchantID,
                                                  String TerminalID,
                                                  String AccountLogin,
    ...
    public static Document createMcPaymentFacilitatorDocument(String MerchantID,
                                                  String TerminalID,
                                                  String AccountLogin,
                                                  String ReqMerchantID,
                                                  String Mcc,
    ...
    public static Document createVisaPaymentFacilitatorClicheDocument(String MerchantID,
                                                                      String TerminalID,
                                                                      String AccountLogin,
                                                                      String ReqMerchantID,
                                                                      String Mcc,
