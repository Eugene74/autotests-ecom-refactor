...
public class RequestSender {
  ...
  public static Document sendRequest(String url, Document request) {
    ...
    String receiveResponse =
        httpRequestSender.post(DocumentTools.convertXMLDocumentToString(request));
  ...
  public RequestSender(String url) {
    try {
      ...
      System.out.println(">>> Error on open create");
    } catch (IOException ex) {
      System.out.println(">>> Error on open connection");
    } catch (Exception e) {
