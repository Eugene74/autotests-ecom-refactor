...
public class DocumentTools {
  ...
  public static String printRequest(Document doc) {
    ...
    doc =
        convertStringToXmlDocument(
            convertXMLDocumentToString(doc).replaceAll("(?:>)(\\s*)<", "><"));
  ...
  public static void verifiedDataResponsePayment(Document response, String[] tags, int index) {
    for (String tag : tags) {
      if (index == 1) {
        System.out.print(
            "RS_Payment_" + tag + ": " + getSecondElementFromDocument(response, tag) + "\n");
      } else {
  ...
  public static void verifiedDataMTFromDBFunding(String rrn, String[] tags) {
    for (String tag : tags) {
      switch (tag) {
        ...
        default:
          System.out.print(
              "DB_Funding_" + tag + ": " + JDBCMethods.getValueFromMTTran(rrn, tag) + "\n");
          break;
      }
    }
    System.out.println("-----------------------------------------------");
  ...
  public static void verifiedDataMTFromDBPayment(String rrn, String[] tags) {
    for (String tag : tags) {
      if (tag.equals("RRN")) System.out.print("DB_Payment_RRN: " + rrn + "\n");
      else
        System.out.print(
            "DB_Payment_" + tag + ": " + JDBCMethods.getValueFromMTTran(rrn, tag) + "\n");
    }
    System.out.println("-----------------------------------------------");
  }
  ...
  public static Document fillGetInstPlanRequest(
      Document doc, String[] card, String amount, String merch, String term) {
  ...
  public static Document fillRequestData(
      Document request, String[] card, String merch, String term, String desc) {
    ...
    request
        ...
        .getAttributes()
        .item(0)
        .setTextContent(sdf.format(date));
    request
        .getElementsByTagName("OrderID")
        .item(0)
        .setTextContent(String.valueOf(rnd.nextInt(100000, 999999)));
    request.getElementsByTagName("Date").item(0).setTextContent(sdf.format(date));
    request
        .getElementsByTagName("TotalAmount")
        .item(0)
        .setTextContent(String.valueOf(rnd.nextInt(1001, 9999)));
    //        TODO for Borica
  ...
  public static Document fillTokenRequestData(
      Document request, String[] token, String merch, String term, String desc) {
    fillMerchant(request, merch, term);
  ...
  public static Document fillRequestDataBorica(
      Document request, String[] card, String merch, String term, String desc, String amount) {
    fillMerchant(request, merch, term);
    fillCardData(request, card);
    request
        .getElementsByTagName("Message")
  ...
  public static Document fillRequestDataAmount(
      Document request, String[] card, String merch, String term, String desc, String amount) {
    fillMerchant(request, merch, term);
    fillCardData(request, card);
    request
  ...
  public static Document fillLocalInstChoice(
      Document request,
      String instPlanParamId,
      String numberOfPay,
      String feeMonth,
      String interestRate,
      String checkValue) {
    //        request.renameNode(request.getElementsByTagName("PayData").item(0), "",
    // "InternalInstallmentChoice");
  ...
  public static Document fillInvoice(Document requestRevers, Document requestPay) {
    ...
    requestRevers
        .getElementsByTagName("OrderID")
        .item(0)
        .setTextContent(requestPay.getElementsByTagName("OrderID").item(0).getTextContent());
    requestRevers
        .getElementsByTagName("Date")
        .item(0)
        .setTextContent(requestPay.getElementsByTagName("Date").item(0).getTextContent());
    requestRevers
        .getElementsByTagName("TotalAmount")
        .item(0)
        .setTextContent(
            requestPay.getElementsByTagName(getTagAmount(requestPay)).item(0).getTextContent());
    try {
      requestRevers
  ...
  public static Document fillAmountToRefund(
      Document requestRevers, Document requestPay, String tag, double n) {
    String amountText =
        requestPay.getElementsByTagName(getTagAmount(requestPay)).item(0).getTextContent();
  ...
  public static Document fillFromResponseData(Document request, Document responsePay) {
    ...
    setAttributeToDocument(
        request, "MerchantID", getElementFromDocument(responsePay, "MerchantID"));
    setAttributeToDocument(
        request, "TerminalID", getElementFromDocument(responsePay, "TerminalID"));
    setAttributeToDocument(request, "Rrn", getElementFromDocument(responsePay, "Rrn"));
    setAttributeToDocument(
        request, "ApprovalCode", getElementFromDocument(responsePay, "ApprovalCode"));
    try {
      request
          .getElementsByTagName("checkData")
          .item(0)
          .setTextContent(responsePay.getElementsByTagName("checkData").item(1).getTextContent());
    } catch (Exception ex) {
      ex.getLocalizedMessage();
    }
    return request;
  ...
  public static Document fillRequestRefund(
      Document requestRevers, Document requestPay, Document responsePay, double delta) {
  ...
  public static Document fillPostRequest(
      Document requestPostAuth,
      Document requestPreAuth,
      Document responsePreAuth,
      String description,
      double delta) {
    ...
    requestPostAuth.renameNode(
        requestPostAuth.getElementsByTagName("Refund").item(0), "", "Postauthorization");
    requestPostAuth.renameNode(
        requestPostAuth.getElementsByTagName("RefundData").item(0), "", "PostauthorizationData");
    requestPostAuth.renameNode(
        requestPostAuth.getElementsByTagName("RefundAmount").item(0),
        "",
        "PostauthorizationAmount");
    requestPostAuth.renameNode(
        requestPostAuth.getElementsByTagName("AuthorizationRef").item(0),
        "",
        "PreauthorizationRef");
  ...
  public static Document fillRequestAccountToCard(
      Document request, String[] cardP, String merch, String term) {
    fillRequestDataMT(request, merch, term);
    request.getElementsByTagName("RecipientCardNumber").item(0).setTextContent(cardP[0]);
    return request;
  }

  public static Document fillRequestCardToAccount(
      Document request, String[] cardF, String merch, String term) {
    fillRequestDataMT(request, merch, term);
  ...
  public static Document fillRequestDataMT(Document request, String merch, String term) {
    ...
    request
        .getElementsByTagName("TrackingId")
        .item(0)
        .setTextContent(String.valueOf(rnd.nextInt(100000, 999999)));
    request
        .getElementsByTagName("Value")
        .item(0)
        .setTextContent(String.valueOf(rnd.nextInt(100, 10000)));
    return request;
  }

  public static Document fillRequestCartToCard(
      Document request, String[] cardF, String[] cardP, String merch, String term) {
    fillRequestDataMT(request, merch, term);
    updateMTCardDataFunding(request, cardF);
    request.getElementsByTagName("RecipientCardNumber").item(0).setTextContent(cardP[0]);
    return request;
  ...
  public static Document fillReversalOnFunding(
      Document requestRev, String merch, String term, Document request, Document response) {
  ...
  public static void fillFastRefundAPI(
      Document newRequestDoc, String merch, String term, Document request, Document response) {
  ...
  public static Document fillCreateItemPan(
      Document doc,
      String merchantId,
      String terminalId,
      String trackingId,
  ...
  public static Document fillGetItemPan(
      Document doc, String merchantId, String terminalId, String trackingId, String stopListId) {
    doc.getElementsByTagName("MerchantID").item(0).setTextContent(merchantId);
    doc.getElementsByTagName("TerminalID").item(0).setTextContent(terminalId);
    doc.getElementsByTagName("trackingId").item(0).setTextContent(trackingId);
  ...
  public static Document fillUpdateItemPan(
      Document doc,
      String merchantId,
      String terminalId,
      String trackingId,
  ...
  public static Document fillFindItemPan(
      Document doc,
      String merchantId,
      String terminalId,
      String trackingId,
  ...
  public static Document fillDeleteItemPan(
      Document doc, String merchantId, String terminalId, String trackingId, String stopListId) {
    doc.getElementsByTagName("MerchantID").item(0).setTextContent(merchantId);
    doc.getElementsByTagName("TerminalID").item(0).setTextContent(terminalId);
    doc.getElementsByTagName("trackingId").item(0).setTextContent(trackingId);
  ...
  public static Document fillCreateMcPaymentFacilitator(
    ...
    for (int i = 0; i < cells.getLength(); i++) {
      ...
      item.getElementsByTagName("terminal_type_id").item(0).setTextContent(terminal_type_id);
      item.getElementsByTagName("identification").item(0).setTextContent(identification);
      item.getElementsByTagName("mcPaymentFacilitatorId")
          .item(0)
          .setTextContent(mcPaymentFacilitatorId);
      item.getElementsByTagName("mcIndependentSalesOrgId")
          .item(0)
          .setTextContent(mcIndependentSalesOrgId);
  ...
  public static Document fillcreateVisaPaymentFacilitatorCliche(
    ...
    for (int i = 0; i < cells.getLength(); i++) {
      ...
      item.getElementsByTagName("terminal_type_id").item(0).setTextContent(terminal_type_id);
      item.getElementsByTagName("identification").item(0).setTextContent(identification);
      item.getElementsByTagName("visaPaymentFacilitatorId")
          .item(0)
          .setTextContent(visaPaymentFacilitatorId);
      item.getElementsByTagName("visaIndependentSalesOrgId")
          .item(0)
          .setTextContent(visaIndependentSalesOrgId);
  ...
  public static Document fillGetMerchant(
      Document doc,
      String MerchantID,
      String TerminalID,
      String AccountLogin,
  ...
  public static Document fillDeleteMerchant(
      Document doc,
      String MerchantID,
      String TerminalID,
      String AccountLogin,
  ...
  public static Document fillUpdateMerchant(
      Document doc,
      String MerchantID,
      String TerminalID,
      String AccountLogin,
  ...
  public static Document fillGetStatus(
      Document doc, String MerchantID, String TerminalID, String RequestID) {
    doc.getElementsByTagName("MerchantID").item(0).setTextContent(MerchantID);
    doc.getElementsByTagName("TerminalID").item(0).setTextContent(TerminalID);
  ...
  public static String printRequestMT(Document doc) {
    try {
      ...
      doc.getElementsByTagName("CardNumber")
          .item(0)
          .setTextContent(maskString(cardNumberFunding, 6, 12));
      doc.getElementsByTagName("CVV2").item(0).setTextContent(maskString(cvv, 0, 3));
    } catch (Exception e) {
      System.out.println(">>> Tag is missing in response");
    }
    try {
      String cardNumberPayment =
          doc.getElementsByTagName("RecipientCardNumber").item(0).getTextContent();
      doc.getElementsByTagName("RecipientCardNumber")
          .item(0)
          .setTextContent(maskString(cardNumberPayment, 6, 12));
    } catch (Exception e) {
  ...
  public static Document fillValueByTagsFR(Document dataFrom, Document dataTo, String tag) {
    ...
    if (dataFrom != null
        && dataFrom.getElementsByTagName(tag).getLength() > 0
        && dataFrom.getElementsByTagName(tag).item(0) != null) {
      String fromValue = dataFrom.getElementsByTagName(tag).item(0).getTextContent();
      if (dataTo != null
          && dataTo.getElementsByTagName(tag).getLength() > 0
          && dataTo.getElementsByTagName(tag).item(0) != null) {
        dataTo.getElementsByTagName(tag).item(0).setTextContent(fromValue);
      } else {
  ...
  /** for MPI */
  public static Document fillRequestMPIData(
      Document request, String[] card, String merch, String term, String desc) {
    fillMerchant(request, merch, term);
  ...
  public static String printRequestMpiAuth(Document doc) {
    try {
      ...
      doc.getElementsByTagName("PaRes")
          .item(0)
          .setTextContent(pares.substring(0, 10) + " ... " + pares.substring(pares.length() - 10));
    } catch (NullPointerException n) {
      System.out.println("Tag is missing");
    }
    doc =
