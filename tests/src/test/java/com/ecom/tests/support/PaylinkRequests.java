...
public class PaylinkRequests {
  ...
  public static Document paymentToken(
      String[] token, String description, String merch, String term) {
  ...
  public static Document paymentBorica(
      String[] card, String description, String merch, String term, String amount) {
    Document newRequestDoc = DocumentTools.readXMLFile(XML_TEMPLATES_PAY_REQ_PATH);
    fillRequestDataBorica(newRequestDoc, card, merch, term, description, amount);
    return newRequestDoc;
  }

  public static Document paymentAmount(
      String[] card, String amount, String description, String merch, String term) {
    Document newRequestDoc = DocumentTools.readXMLFile(XML_TEMPLATES_PAY_REQ_PATH);
    fillRequestDataAmount(newRequestDoc, card, merch, term, description, amount);
    return newRequestDoc;
  }

  public static Document paymentPares(
      String[] card, String description, String merch, String term) {
    Document newRequestDoc = payment(card, description, merch, term);
    fillParesData(newRequestDoc, card, "PayData");
    return newRequestDoc;
  }

  public static Document getInstPlansRequest(
      String[] card, String amount, String merch, String term) {
  ...
  public static Document paymentLocalInstallment(
      String[] card,
      String description,
      String merch,
      String term,
      ...
      String feeMonth,
      String interestRate,
      String checkValue) { // , String [] insData){
    ...
    //      fillParesData(newRequestDoc, card, "PayData");
    fillLocalInstChoice(
        newRequestDoc, instPlanParamId, numberOfPay, feeMonth, interestRate, checkValue);
    return newRequestDoc;
  }
  ...
  public static Document paymentEmvBorica(
      String[] card, String description, String merch, String term, String amount) {
  ...
  public static Document paymentCheckout(
      String[] card, String description, String merch, String term) {
    Document newRequestDoc = payment(card, description, merch, term);
  ...
  public static Document paymentAddendum(
      String[] card, String description, String merch, String term, String paysys) {
    Document newRequestDoc = paymentPares(card, description, merch, term);
    fillAddendumData(newRequestDoc, paysys);
    return newRequestDoc;
  }

  public static Document paymentMasterpass(
      String[] card, String description, String merch, String term) {
    Document newRequestDoc = payment(card, description, merch, term);
  ...
  public static Document paymentRecurent(
      String[] card, String description, String merch, String term, String value) {
    Document newRequestDoc = payment(card, description, merch, term);
    addTags(newRequestDoc, "PayData", "Recurrent", value);
    return newRequestDoc;
  }

  public static Document paymentPreAuth(
      String[] card, String description, String merch, String term) {
    Document newRequestDoc = payment(card, description, merch, term);
    newRequestDoc.renameNode(
        newRequestDoc.getElementsByTagName("Authorization").item(0), "", "Preauthorization");
    return newRequestDoc;
  }

  public static Document paymentPreAuthPares(
      String[] card, String description, String merch, String term) {
    Document newRequestDoc = paymentPares(card, description, merch, term);
    newRequestDoc.renameNode(
        newRequestDoc.getElementsByTagName("Authorization").item(0), "", "Preauthorization");
  ...
  public static Document paymentPostAuth(
      Document requestPay, Document responsePay, String description, double delta) {
  ...
  public static Document settlementRefund(
      String[] card, String description, String merch, String term) {
    Document newRequestDoc = payment(card, description, merch, term);
  ...
  public static Document enrollRequest(
      String[] card, String description, String merch, String term) {
