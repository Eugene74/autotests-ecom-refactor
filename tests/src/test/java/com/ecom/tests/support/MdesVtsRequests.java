...
public class MdesVtsRequests extends BaseApiTest {
  ...
  public String prepareCreateTokenRequest(
    ...
    try {
      return prepareRequest(
          xmlTemplatePath, trackingId, null, cardNumber, null, merchantId, terminalId, null);
    } catch (IOException e) {
  ...
  public String prepareTokenActionRequest(
    ...
    try {
      return prepareRequest(
          xmlTemplatePath, trackingId, tokenID, null, null, merchantId, terminalId, null);
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public String prepareCardContentRequest(
    ...
    try {
      return prepareRequest(
          xmlTemplatePath, trackingId, null, null, contentId, merchantId, terminalId, brand);
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  }
