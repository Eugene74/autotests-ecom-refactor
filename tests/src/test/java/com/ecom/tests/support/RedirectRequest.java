...
public class RedirectRequest {
   ...
   //     new PaymentSteps(driver).authorizePayment(
   //     new PaymentSteps(driver)
  //      new RefundSteps(driver).doRefund
  //      new InvoiceSteps(driver).payInvoice
  //      new PaymentSteps(driver).authorizePaymentInstallment
  //      new RefundSteps(driver).postAuthorization(URL_MERCH,
  //      new RefundSteps(driver).postAuthorizationWithDiffAmount(URL_MERCH,
