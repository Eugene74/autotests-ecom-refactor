...
public class PaymentSteps {
    ...
    public String authorizePayment(String[] card, int delay, String merch, String term, String redirectUrl) {
    ...
    public String authorizePaymentInstallment(String[] card, int delay, String merch, String term, String redirectUrl) {
