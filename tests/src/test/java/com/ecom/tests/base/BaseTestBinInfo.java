...
public class BaseTestBinInfo extends BaseApiTest {
    ...
    protected void verifyXmlResponse(String xml, SoftAssert softAssertion, String tagName) throws Exception {
        ...
        boolean isListBinInfoNotEmpty = listBinInfoNodes.getLength() > 0 && !listBinInfoNodes.item(0).getTextContent().trim().isEmpty();
    ...
    protected String generateUniqueRequestID() {return "REQ" + System.currentTimeMillis();
    }
}
